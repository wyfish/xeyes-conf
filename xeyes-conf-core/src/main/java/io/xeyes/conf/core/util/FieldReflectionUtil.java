...
public final class FieldReflectionUtil {
	...
	public static Byte parseByte(String value) {
		try {
			...
			throw new XEyesConfException("parseByte but input illegal input=" + value, e);
		}
	}
	...
	public static Boolean parseBoolean(String value) {
		...
		if (Boolean.TRUE.toString().equalsIgnoreCase(value)) {
			...
			throw new XEyesConfException("parseBoolean but input illegal input=" + value);
		}
	}
	...
	public static Integer parseInt(String value) {
		try {	
			...
			throw new XEyesConfException("parseInt but input illegal input=" + value, e);
		}
	}
	...
	public static Short parseShort(String value) {
		try {
			...
			throw new XEyesConfException("parseShort but input illegal input=" + value, e);
		}
	}
	...
	public static Long parseLong(String value) {
		try {
			...
			throw new XEyesConfException("parseLong but input illegal input=" + value, e);
		}
	}
	...
	public static Float parseFloat(String value) {
		try {
			...
			throw new XEyesConfException("parseFloat but input illegal input=" + value, e);
		}
	}
	...
	public static Double parseDouble(String value) {
		try {
			...
			throw new XEyesConfException("parseDouble but input illegal input=" + value, e);
		}
	}
